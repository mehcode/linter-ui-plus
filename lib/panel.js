    ...
    return (
      ...
      >
        <div className="btn-toolbar">
          <button className="btn icon icon-fold"></button>
          <div className="btn-group">
            <button className="btn selected">All</button>
            <button className="btn">Errors</button>
            <button className="btn">Warnings</button>
          </div>
          <button className="btn icon icon-arrow-left"></button>
          <button className="btn icon icon-arrow-right"></button>
